      ...
      <div className="container mx-auto px-6 md:px-8 max-w-5xl">
        <div className="grid lg:grid-cols-2 gap-8 items-center justify-center">
          ...
          >
            ...
            <motion.h2 
              variants={fadeInUp}
              className="text-3xl md:text-4xl font-heading font-bold text-[#424242] mb-4 leading-tight"
            >
              Repense o jeito <br />
            ...
            <motion.p 
              variants={fadeInUp}
              className="text-xs sm:text-sm md:text-lg text-[#666666] font-body mb-8 leading-relaxed w-full px-2 md:px-0"
            >
