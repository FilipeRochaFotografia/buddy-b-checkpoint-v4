...
const showcaseImages = [
  "/assets/images/7474menor.png",
  "/assets/images/06menor.png",
  "/assets/images/04menor.png"
];
...
const features = [
  ...
  { 
    ...
    text: (
      <>
        <span className="font-bold">Integração bancária</span> <br/>
        automática de contas e cartões
      </>
    )
  },
  { 
...
export function ValueProposition() {
  ...
  return (
    // AJUSTE 1: Fundo termina em #F8F9FA (mesma cor que começa o Pricing)
    <section className="py-20 bg-gradient-to-b from-white to-[#F8F9FA] relative overflow-hidden">
      
      {/* AJUSTE 2: ADICIONADO OS BLOBS ROXOS (IGUAL AO PRICING) */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-lg text-[#666666] font-body font-light">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 flex justify-center lg:justify-end">
             <div className="relative w-full max-w-2xl h-[500px] md:h-[600px] flex items-center justify-center">
                
                {/* Glow atrás do celular */}
                <div className="absolute inset-0 bg-primary/20 blur-[80px] rounded-full scale-90 -z-10"></div>
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center h-full">
            ...
            <div className="relative min-h-[420px] flex flex-col justify-center w-full max-w-[380px] mx-auto lg:mx-0">
              <AnimatePresence mode="wait">
                <motion.div
                  key={page}
                ...
                >
                  {currentFeatures.map((feature, idx) => (
                    <motion.div
                      ...
                      className="bg-white border border-purple-100 p-5 rounded-[16px] shadow-lg hover:shadow-xl hover:border-primary/30 transition-all duration-300 transform hover:-translate-x-1 flex items-center h-[100px]"
                    >
                      <div className="flex items-center gap-4 w-full">
                        <div className="w-1.5 h-12 bg-gradient-to-b from-primary to-gray-200 rounded-full shrink-0"></div>
                        <p className="text-[#424242] text-lg leading-tight font-body">
                          {feature.text}
                        </p>
                      </div>
                    </motion.div>
            ...
            {/* Navegação */}
            <div className="flex items-center justify-center lg:justify-start gap-8 mt-6 w-full max-w-[380px] mx-auto lg:mx-0">
              <button 
                onClick={prevPage}
                className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary hover:bg-white hover:shadow-md transition-all"
              >
