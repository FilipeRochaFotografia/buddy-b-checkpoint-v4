            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 bg-[#9B80FF] rounded-[4px] flex items-center justify-center hover:bg-[#8a6df0] transition-colors">
                <svg width="6" height="12" viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5.6 6.2L5.9 4.2H4V2.9C4 2.3 4.4 1.8 4.9 1.8C5 1.8 5 1.8 5.1 1.8H6V0.1C5.5 3.7998e-07 5 0 4.4 0C2.8 0 1.8 1 1.8 2.7V4.2H0V6.2H1.8V11.1C2.2 11.2 2.5 11.2 2.9 11.2C3.3 11.2 3.6 11.2 4 11.1V6.2H5.6Z" fill="white"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="#" className="w-10 h-10 bg-[#9B80FF] rounded-[4px] flex items-center justify-center hover:bg-[#8a6df0] transition-colors">
              ...
              <a href="#" className="w-10 h-10 bg-[#9B80FF] rounded-[4px] flex items-center justify-center hover:bg-[#8a6df0] transition-colors">
                <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4.8 12.0516C9.5 12.0516 13.4 8.25156 13.4 3.55156V3.45156C13.4 3.35156 13.4 3.15156 13.4 3.05156C14 2.65156 14.5 2.05156 14.9 1.45156C14.3 1.65156 13.8 1.85156 13.2 1.95156C13.8 1.55156 14.3 0.951561 14.5 0.251561C13.9 0.651561 13.3 0.85156 12.6 0.95156C11.5 -0.24844 9.5 -0.348439 8.3 0.851561C7.5 1.55156 7.2 2.65156 7.4 3.75156C5 3.65156 2.7 2.45156 1.2 0.551561C0.4 1.95156 0.8 3.75156 2.1 4.55156C1.6 4.55156 1.1 4.45156 0.7 4.15156C0.7 5.55156 1.7 6.85156 3.1 7.15156C2.7 7.25156 2.2 7.25156 1.7 7.25156C2.1 8.45156 3.2 9.35156 4.5 9.35156C3.4 10.1516 2.1 10.6516 0.7 10.6516C0.5 10.6516 0.2 10.6516 0 10.6516C1.5 11.5516 3.1 12.0516 4.8 12.0516Z" fill="white"/>
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="#" className="w-10 h-10 bg-[#9B80FF] rounded-[4px] flex items-center justify-center hover:bg-[#8a6df0] transition-colors">
